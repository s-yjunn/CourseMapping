    ...
    <div class="tabcontent">
        <div class="card border">
            ...
            <div class="wrapper2">
                ...
                <div id="Collectibles"> <a class="imageClass" style='border: 3px white' href="Merch/collection.php"> <img class="imageClass" src="Merch/Images/notebook.png" alt="bm" ></a></div>

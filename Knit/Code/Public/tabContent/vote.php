...
<div id="Vote" class="tabcontent">
	...
	<div id="contestHome">
		...
		<div class="entriesVote">
			...
			<p>Vote for your favorite knitting creations from this week's user submissions!</p>
			<?php if($numCont == 0): ?>
					...
					<div class="col-xl-3 col-md-6 col-xs-12">
						<div class="card" id = '<?= $i; ?>'>
							<div class='card-body'>
								...
								<button class="btn2" type="button" onclick="openPattern(<?= $i; ?>, 'contestPattern', 'contestHome')">View</button>
								<form>

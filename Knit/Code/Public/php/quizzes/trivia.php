...
<img src="imgs/quizzes/backbutton.jpg" alt="back button" id="back4" class="backBtnImg">
  ...
  <h2 class="quiz-question">How long has knitting been around?</h2>
  ...
  <h2 class="quiz-question">Where were the earliest known samples of fabrics and yarns found?</h2>
  ...
  <h2 class="quiz-question">Approximately how old are the earliest known samples of fabrics and yarns?</h2>
  ...
  <h2 class="quiz-question">How many calories could you do burn after knitting for a half hour?</h2>
  ...
  <h2 class="quiz-question">What is David Babcock's Guinness World Record?</h2>
  ...
  <h2 class="quiz-question">When did the word "knitting" first appear in the English language?</h2>
  ...
  <h2 class="quiz-question">In 2012 the record for the most people knitting simultaneously was broken. How many people were knitting?</h2>
  ...
  <h2 class="quiz-question">Between 2002 and 2004, the number of women knitters in the U.S. ages 25–35 increased nearly _%.</h2>
  ...
  <h2 class="quiz-question">When is World Wide Knit in Public Day?</h2>
  ...
  <h2 class="quiz-question">Who started World Wide Knit in Public Day?</h2>
